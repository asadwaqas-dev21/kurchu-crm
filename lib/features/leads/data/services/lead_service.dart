...
class LeadService {
  ...
  Future<({List<LeadModel> leads, int total, int skip, int limit})> getLeads({
    ...
    try {
      ...
      final List<LeadModel> leads = rawLeads.map((e) => LeadModel.fromJson(e)).toList();
      ...
      return (leads: leads, total: total, skip: responseSkip, limit: responseLimit);
    } catch (e) {
      print('Exception in getLeads: $e');
      return (leads: <LeadModel>[], total: 0, skip: skip ?? 0, limit: limit ?? 10);
    }
  }
